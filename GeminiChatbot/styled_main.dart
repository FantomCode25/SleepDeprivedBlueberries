    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(
          ...
          foregroundColor: NutriPalTheme.lightTextColor,
          elevation: 0,
          centerTitle: true,
        ),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: NutriPalTheme.secondaryColor),
          ),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: NutriPalTheme.secondaryColor.withOpacity(0.5)),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: NutriPalTheme.primaryColor, width: 2),
          ),
        ),
        useMaterial3: true,
      ),
